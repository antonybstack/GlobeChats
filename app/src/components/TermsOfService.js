...
const TermsOfService = () => {
    return (
        <div class="tos">
            ...
            whether personally or on behalf of an entity (“you”) and GlobeChats
            ("Company", “we”, “us”, or “our”), concerning your access to and use of the
            https://globechats.herokuapp.com/ website as well as any other media form,
            ...
            agreements made and to be entirely performed within the State of North
            ...
            arbitration will take place in Mecklenburg County, North Carolina. Except as
            ...
            located in Mecklenburg County, North Carolina, and the Parties hereby
