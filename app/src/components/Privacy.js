...
const Privacy = () => {
    return (
        <div className="tos">
            ...
            <p>
            Thank you for choosing to be part of our community at GlobeChats (<b>"Company"</b>,
            <b>"we"</b>, <b>"us"</b>, <b>"our"</b>). We are committed to protecting your personal information
            ...
            please contact us at privacy@mattrossi.me.
            </p>

            <p>
            When you and more generally, use any of our services (the <b>"Services"</b>, which
            include the application), we appreciate that you are trusting us with your personal
            ...
            Services (which, as described above, includes our application), as well as, any related
            ...
            register on the express an interest in obtaining information about us or our
            products and Services, when you participate in activities on the (such as by
            ...
            Facebook, Twitter or other social media account. If you choose to register
            ...
            the application. This information does not reveal your specific identity
            ...
            country, location, information about how and when you use our and other
            technical information. This information is primarily needed to maintain the
            security and operation of our , and for our internal analytics and reporting
            purposes.
            </p>
            ...
            <li>
                ...
                interact with public areas of the application, such personal information
                may be viewed by all users and may be publicly made available outside the
                application in perpetuity. Other users will may be able to view
                descriptions of your activity, communicate with you within our
                application, and view your profile.
            </li>
            </ul>
            ...
            <p>
            Our application offers you the ability to register and login using your
            third-party social media account details (Google account login). Where you
            choose to do this, we will receive certain profile information about you
            from Google. The profile information we receive will include your name,
            email address, and profile picture.
            </p>

            <p>
            We will use the information we receive only for the purposes that are
            described in this privacy notice. Please note that we do not control, and
            ...
            application from outside of the United States, please be aware that your
            ...
            information (see "WILL YOUR INFORMATION BE SHARED WITH ANYONE?" above), in
            ...
            other similar laws as comprehensive as those in your country. We will
            ...
            of age. By using the application, you represent that you are at least 18 or
            that you are the parent or guardian of such a minor and consent to such
            minor dependent’s use of the application. If we learn that personal
            ...
            from children under age 18, please contact us at privacy@mattrossi.me.
            </p>
            ...
            account or terminate your account, you can email privacy@mattrossi.me.
            </p>
            ...
            registered account with , you have the right to request removal of unwanted
            data that you publicly post on the . To request removal of such data, please
            contact us using the contact information provided below, and include the
            email address associated with your account and a statement that you reside
            ...
            update, or delete your personal information, please email
            privacy@mattrossi.me.
            </p>
        </div>
    );
